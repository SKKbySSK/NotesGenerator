...
namespace NotesGenerator.SoundTouch
{
    class VarispeedSampleProvider : ISampleProvider, IDisposable
    {
        ...
        public VarispeedSampleProvider(ISampleProvider sourceProvider, int readDurationMilliseconds, SoundTouchProfile soundTouchProfile)
        {
            ...
            Console.WriteLine(String.Format("SoundTouch Version {0}", soundTouch.VersionString));
            Console.WriteLine("Use QuickSeek: {0}", soundTouch.GetUseQuickSeek());
            Console.WriteLine("Use AntiAliasing: {0}", soundTouch.GetUseAntiAliasing());
